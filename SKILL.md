...
description: Use when user asks for Bible verses, scripture references, biblical passages, or commentary - supports 1000+ translations, verse/chapter lookup, and Bible commentaries via HelloAO API
---
...
```dot
digraph bible_lookup {
  rankdir=TB;
  "Parse reference" -> "Detect language";
  "Detect language" -> "Select translation";
  "Select translation" -> "Fetch chapter";
  "Fetch chapter" -> "Extract verses";
  "Extract verses" -> "Format output";
}
```
...
2. Detect: English prompt → use BSB
